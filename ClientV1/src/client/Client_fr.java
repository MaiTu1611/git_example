...
public class Client_fr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(631, 13, 93, -1));
        ...
        getContentPane().add(send_msg, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 362, 526, 30));
        ...
        getContentPane().add(bsend, new org.netbeans.lib.awtextra.AbsoluteConstraints(552, 359, -1, 30));
        ...
        getContentPane().add(call, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 330, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Untitled-1.jpg"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, 740, 430));
...
//         (new FileReader("d:\\Client\\src\\about.txt"));
//         String str;
